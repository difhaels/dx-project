    ...
    <>
      <div className="px py-10 bg-slate-100">
        ...
        <div className="flex flex-wrap justify-center gap-7 sm:gap-14 pb-10">
          <img src={etc1} alt="img-gallery" className="img-paket" />
          <img src={etc2} alt="img-gallery" className="img-paket" />
          <img src={etc3} alt="img-gallery" className="img-paket" />
          <img src={etc4} alt="img-gallery" className="img-paket" /> 
        </div>
        <div>
