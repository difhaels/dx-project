    ...
    <>
      <div className="px py-10 bg-slate-100">
        ...
        <div className="flex flex-wrap justify-center gap-7 sm:gap-14 pb-10">
          <img src={pet1} alt="img-gallery" className="img-paket" />
          <img src={pet2} alt="img-gallery" className="img-paket" />
          <img src={pet3} alt="img-gallery" className="img-paket" />
          <img src={pet4} alt="img-gallery" className="img-paket" />
        </div>
        <div>
