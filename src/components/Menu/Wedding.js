    ...
    <>
      <div className="px py-10 bg-slate-100">
        ...
        <div className="flex flex-wrap justify-center gap-7 sm:gap-14 pb-10">
          <img src={wedding1} alt="img-gallery" className="img-paket" />
          <img src={wedding2} alt="img-gallery" className="img-paket" />
          <img src={wedding3} alt="img-gallery" className="img-paket" />
          <img src={wedding4} alt="img-gallery" className="img-paket" />
        </div>
        <div>
