  ...
  return (
    <>
      ...
      <div className="px text-center text-text bg-[#E3F4F4] pb-10 sm:pb-40">
        <h1 className="text-xl py-10" id="pesan">Mau Foto Apa?</h1>
        <div className="flex justify-center">

          <div className="group border-luar" onClick={() => navigate('family')}>
          ...
          <div className="group border-luar" onClick={() => navigate('graduation')}>
            <div className="border-dalam">
          ...
          <div className="group border-luar" onClick={() => navigate('group')}>
            <div className="border-dalam">
        ...
        <div className="flex justify-center">
          ...
          <div className="group border-luar" onClick={() => navigate('wedding')}>
            <div className="border-dalam">
          ...
          <div className="group border-luar" onClick={() => navigate('pet')}>
            <div className="border-dalam">
          ...
          <div className="group border-luar" onClick={() => navigate('etc')}>
            <div className="border-dalam">
